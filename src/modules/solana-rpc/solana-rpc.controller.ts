...
export class SolanaRpcController {
  ...
  @ApiOperation({
    ...
    description: 'Returns the market capitalization of 5 random assets.',
  })
  ...
  @Get('/tps')
  @ApiOperation({
    summary: 'Get transactions per second metric',
    description: 'Returns transactions per second metric for the last 12hours',
  })
